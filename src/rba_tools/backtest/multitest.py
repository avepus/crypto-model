...
def parse_args(pargs=None):
    ...
    parser.add_argument('--data0', default=r'C:\Users\Avery\Documents\GitHub\backtrader-master\datas\nvda-1999-2014.txt',
                        required=False, help='Data0 to read in')

    parser.add_argument('--data1', default=r'C:\Users\Avery\Documents\GitHub\backtrader-master\datas\yhoo-1996-2014.txt',
                        required=False, help='Data1 to read in')

    parser.add_argument('--data2', default=r'C:\Users\Avery\Documents\GitHub\backtrader-master\datas\orcl-1995-2014.txt',
                        required=False, help='Data1 to read in')
